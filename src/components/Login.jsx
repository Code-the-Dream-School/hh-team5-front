...
const Login = ({ cancel }) => {
    ...
    return (
        <div className={`w-5/6 md:w-4/12 h-auto  bg-transparent absolute top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%]`}>
            ...
            <div className={`bg-white pb-5 rounded-md`}>
                ...
                <form onSubmit={handleSubmit(login ? handleLogin : handleRegister)} autoComplete='off' className={`flex flex-col w-3/5 m-auto mt-8`}>
